...
| [`human-voice`](./skills/human-voice) | `apatheticus-skills` | Strip signs of AI-generated writing and rewrite prose so it reads as human-authored. Picks a register first (editorial, professional, technical, regulated, or commercial) so a spec never gets an essay's voice and a statement of work never promises more than was priced. Yields to a compliance skill for federal work. | `npx skills add apatheticus/skills -s human-voice` |

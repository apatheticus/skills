...
<!-- One line: which skill, and the job it does. -->
...
- [ ] Row added to the Skills table in `README.md`
- [ ] `version` bumped in `.claude-plugin/plugin.json`
- [ ] No secrets, tokens, machine-specific absolute paths, or ungated destructive commands

## Verified against

<!-- What you actually ran it on, and the outcome. "Tests pass" is not enough. -->

...
Water, so: slow, eased, and small. A wash breathing between two opacities at `12s`,
`ease-in-out`; a pigment mass drifting a few units at `12s`. **No bloom-in
entrance** — the painting is dry. One or two motions on the whole board; nothing
steps, nothing snaps.
...
<style>
  ...
  @keyframes breathe { 0%,100% { opacity: .46 } 50% { opacity: .58 } }
  @media (prefers-reduced-motion: reduce) { .breathe { animation: none; opacity: .52 } }
</style>

<rect class="paper" x="0" y="0" width="1200" height="620"/>
<path class="wash breathe" fill="var(--blue)"  d="M140 160 h300 v150 h-300 Z"/>

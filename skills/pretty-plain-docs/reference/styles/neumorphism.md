...
<rect class="raised"  x="100" y="100" width="320" height="140" rx="22"/>
...
Raised and pressed are the same geometry with the shadow pair swapped — draw both on
one board and the surface reads as a single continuous material.

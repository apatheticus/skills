...
No `pd:viz` animated embeds appear in this file. Any header is centered like every
other embed (`embedding.md` → Centering) and carries no version or date (house-style →
No volatile facts).
